...
function AboutMe() {
    return(
        ...
        <br></br>
        The start of my career has been working in hospitality where I have learned how to adapt to any problem quickly under pressure, have clear concise communication skills, work well as a team, and meet goals in an extremely fast paced environment under high stress. I have worked my way up to management at every job I have had due to an organized and thorough work ethic. If you have a look at some of my work history in my resume section of this application you will see that I have maintained full time employment in higher ranking positions throughout my time in this field. 
